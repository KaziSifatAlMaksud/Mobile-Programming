...
import java.util.List;
    ...
    public class UpcommingEvent extends AppCompatActivity {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.activity_upcomming_event);
                ...
                btnAddNew.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(UpcommingEvent.this, CreateEventActivity.class);
                        startActivity(i);
                    }
                });
                ...
                btnExit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        spEditor.putString("mail", "");
                        spEditor.putString("user_id", "");
                        spEditor.apply();

                        Intent i = new Intent(UpcommingEvent.this, SignupActivity.class);
                        startActivity(i);
                        finish();
                ...
                builder.setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                KeyValueDB db = new KeyValueDB(UpcommingEvent.this);
